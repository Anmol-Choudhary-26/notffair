...
from user.serializers import UserSerializerForScoreBoard
...
class QuestionSerializer(ModelSerializer):
    id = CharField(help_text="id", max_length=256, min_length=5)
...
class ScoreBoardSerializer(ModelSerializer):
    ...
    user = CharField(max_length=500,read_only=True)
